...
products = api.query(footprint,
                       date=('20211020', '20211120'),  #date----this date download 2
...
#extract and delete the compressed---i'm looking for othger immaginemaybe compressed differentway so maybe useful

for root, dirs, files in os.walk(theWD):
